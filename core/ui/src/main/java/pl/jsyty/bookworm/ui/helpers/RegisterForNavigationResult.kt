package pl.jsyty.bookworm.ui.helpers
...
import pl.jsyty.bookworm.infrastructure.navigation.NavigationResult
import pl.jsyty.bookworm.ui.LocalChildFragmentManager
 ...
 * @param fragmentManager Fragment manager we want to use. Use [LocalChildFragmentManager] for dialogs (default) and [pl.jsyty.bookworm.ui.LocalParentFragmentManager] for results from sibling screens.
